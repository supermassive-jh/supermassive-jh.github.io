...
export const posts: Post[] = [
  ...
  },
  {
    ...
    excerpt: "React Compiler, Tailwind v4, shadcn까지 붙이고 나서 남긴 초기 세팅 메모.",
    date: "2026.07.18",
    category: "React",
    tags: ["React", "Vite"],
  },
  {
    ...
    excerpt: "글 쓰는 사람이 나 하나뿐이라면, 결국 레포에 마크다운 파일 쌓는 게 제일 빠르다.",
    date: "2026.07.17",
    category: "아키텍처",
    tags: ["아키텍처", "블로그"],
  },
  {
    ...
    excerpt: "공개 카운터는 필요 없었다. 나만 보면 되는 숫자는 GA 하나로 충분하다.",
    date: "2026.07.16",
    category: "배포",
    tags: ["배포", "분석"],
  },
